...
public class ElectrolysisCategory extends CreateRecipeCategory<ElectrolysisRecipe> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, ElectrolysisRecipe recipe, IFocusGroup focuses) {
        BackportUtil.addFluidSlot(builder, 30, 50, recipe.getFluidIngredients().get(0));
        BackportUtil.addFluidSlot(builder, 127, 50, recipe.getFluidResults().get(0));
        BackportUtil.addFluidSlot(builder, 148, 50, recipe.getFluidResults().get(1));
    }
