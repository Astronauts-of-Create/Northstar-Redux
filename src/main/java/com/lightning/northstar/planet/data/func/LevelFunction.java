...
public interface LevelFunction {
    ...
    SimpleRegistry<ResourceLocation, Codec<? extends LevelFunction>> REGISTRY = new SimpleRegistry<>();
    ...
    Codec<LevelFunction> CODEC = Codec.either(Codec.FLOAT, CODEC_NO_INLINE)
            .xmap(
                    ...
                    func -> func instanceof ConstantFunction c ? Either.left(c.value()) : Either.right(func)
            );
