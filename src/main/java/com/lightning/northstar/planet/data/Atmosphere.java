...
public record Atmosphere(
    ...
    public static final Codec<Atmosphere> CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            CompoundTag.CODEC.fieldOf("fluid_nbt").forGetter(Atmosphere::fluidNbt),
    ...
    public static class Builder {
        ...
        public Builder fluid(RegistryEntry<? extends Fluid> fluid) {
            return fluid(fluid.get());
        }

        public Builder fluidNbt(CompoundTag fluidNbt) {
            this.fluidNbt = fluidNbt;
            return this;
        }

        public Builder fluid(Fluid fluid, CompoundTag fluidNbt) {
            this.fluid = fluid;
            this.fluidNbt = fluidNbt;
            return this;
        }

        public Builder fluid(RegistryEntry<? extends Fluid> fluid, CompoundTag fluidNbt) {
