...
public class NorthstarDataGenRecipes {
    ...
    public record OreType(Supplier<ItemLike> crushedItem, float expectedAmount, int crushingDuration,
        ...
        public static final OreType
                ...
                GLOWSTONE = new OreType(() -> NorthstarItems.RAW_GLOWSTONE_ORE, 1.75f, 250, () -> Items.GLOWSTONE_DUST, 1.0f, 200),
                ...
                MARTIAN_IRON = new OreType(() -> NorthstarItems.RAW_MARTIAN_IRON_ORE, 1.75f, 250, () -> Items.IRON_INGOT, 0.7f, 200),
                ...
                TITANIUM = new OreType(() -> NorthstarItems.RAW_TITANIUM_ORE, 1.75f, 350, () -> NorthstarItems.TITANIUM_INGOT, 1.0f, 200),
                TUNGSTEN = new OreType(() -> NorthstarItems.CRUSHED_RAW_TUNGSTEN, 1.75f, 450, () -> NorthstarItems.TUNGSTEN_INGOT, 1.0f, 200),
    ...
    public static <T extends Block> NonNullBiConsumer<DataGenContext<Block, T>, RegistrateRecipeProvider> ore(ItemLike stone, OreType type) {
        return (c, p) -> {
            String oreName = RegisteredObjectsHelper.getKeyOrThrow(c.get().asItem()).getPath();

            if (type.crushedItem != null) {
                ProcessingRecipeBuilder<?, ?, ?> builder = new StandardProcessingRecipe.Builder<>(
                        AllRecipeTypes.CRUSHING.<StandardProcessingRecipe.Serializer<?>>getSerializer().factory(),
