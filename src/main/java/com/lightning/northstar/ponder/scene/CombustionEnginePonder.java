...
public class CombustionEnginePonder {
    ...
    public static void program(SceneBuilder sceneBuilder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showOutlineWithText(select.position(4, 3, 3), 80)
        ...
        scene.overlay()
                .showOutlineWithText(select.position(5, 3, 3), 80)
        ...
        scene.overlay()
                .showOutlineWithText(select.position(2, 3, 3), 80)
        ...
        scene.overlay()
                .showOutlineWithText(select.position(2, 2, 3), 80)
