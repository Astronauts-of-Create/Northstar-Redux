...
public class RocketStationPonder {
    ...
    public static void program(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.addKeyframe();
        scene.overlay
                .showSelectionWithText(thruster, 80)
