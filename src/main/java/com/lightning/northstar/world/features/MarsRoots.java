...
public class MarsRoots extends Feature<MarsRootsConfig> {
       public MarsRoots(Codec<MarsRootsConfig> pCodec) {
              super(pCodec);
           }
       ...
       protected static NoiseChunk.BlockStateFiller create(DensityFunction p_209668_, DensityFunction p_209669_, DensityFunction p_209670_, PositionalRandomFactory p_209671_) {
          ...
          return (p_209666_) -> {
             ...
             MarsRoots.VeinType oreveinifier$veintype = d0 > 0.0D ? MarsRoots.VeinType.COPPER : MarsRoots.VeinType.IRON;
    ...
    @Override
    public boolean place(FeaturePlaceContext<MarsRootsConfig> pContext) {
