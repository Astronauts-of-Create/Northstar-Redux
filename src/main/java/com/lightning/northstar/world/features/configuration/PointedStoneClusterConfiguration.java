...
public class PointedStoneClusterConfiguration implements FeatureConfiguration {
       public static final Codec<PointedStoneClusterConfiguration> CODEC = RecordCodecBuilder.create((p_191286_) -> p_191286_.group(Codec.floatRange(0.0F, 1.0F).fieldOf("chance_of_taller_dripstone").orElse(0.2F).forGetter((p_191294_) -> p_191294_.chanceOfTallerDripstone), Codec.floatRange(0.0F, 1.0F).fieldOf("chance_of_directional_spread").orElse(0.7F).forGetter((p_191292_) -> p_191292_.chanceOfDirectionalSpread), Codec.floatRange(0.0F, 1.0F).fieldOf("chance_of_spread_radius2").orElse(0.5F).forGetter((p_191290_) -> p_191290_.chanceOfSpreadRadius2), Codec.floatRange(0.0F, 1.0F).fieldOf("chance_of_spread_radius3").orElse(0.5F).forGetter((p_191288_) -> p_191288_.chanceOfSpreadRadius3), BlockStateProvider.CODEC.fieldOf("stone_provider").forGetter((p_161135_) -> p_161135_.stone_provider), BlockStateProvider.CODEC.fieldOf("base_stone_provider").forGetter((p_161135_) -> p_161135_.base_stone_provider)).apply(p_191286_, PointedStoneClusterConfiguration::new));
