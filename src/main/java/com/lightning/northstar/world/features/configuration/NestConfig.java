...
public class NestConfig implements FeatureConfiguration{
       ...
       public static final Codec<NestConfig> CODEC = RecordCodecBuilder.create((p_160784_) -> p_160784_.group(IntProvider.codec(1, 128).fieldOf("radius").forGetter((p_160802_) -> p_160802_.radius), BlockStateProvider.CODEC.fieldOf("block_provider").forGetter((p_161135_) -> p_161135_.block_provider), BlockStateProvider.CODEC.fieldOf("nest_provider").forGetter((p_161136_) -> p_161136_.nest_provider), BlockStateProvider.CODEC.fieldOf("ground_provider").forGetter((p_161136_) -> p_161136_.ground_provider)).apply(p_160784_, NestConfig::new));
