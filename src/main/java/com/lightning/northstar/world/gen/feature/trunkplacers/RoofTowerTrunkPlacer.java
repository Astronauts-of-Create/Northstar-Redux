...
public class RoofTowerTrunkPlacer extends TrunkPlacer {
    ...
    public static final MapCodec<RoofTowerTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(i -> trunkPlacerParts(i).and(i.group(
    ...
    )).apply(i, RoofTowerTrunkPlacer::new));
    ...
    protected TrunkPlacerType<?> type() {
        return NorthstarTrunkPlacerTypes.ROOF_TOWER_FUNGUS_TRUNK_PLACER.get();
    }
