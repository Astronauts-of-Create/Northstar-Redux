...
public record OreHelper(BootstapContext<PlacedFeature> context, RuleTest baseStone, RuleTest deepStone) {
    public OreHelper(BootstapContext<PlacedFeature> context, TagHelper.Tag<Block> baseStone, TagHelper.Tag<Block> deepStone) {
        this(context, baseStone.tag(), deepStone.tag());
    }

    public OreHelper(BootstapContext<PlacedFeature> context, TagKey<Block> baseStone, TagKey<Block> deepStone) {
