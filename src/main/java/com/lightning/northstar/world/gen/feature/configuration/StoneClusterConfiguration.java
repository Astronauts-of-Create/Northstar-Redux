...
public record StoneClusterConfiguration(
        int floorToCeilingSearchRange,
        BlockStateProvider stoneProvider,
        FluidState fluidProvider,
        IntProvider height,
        IntProvider radius,
    ...
    public static final Codec<StoneClusterConfiguration> CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            BlockStateProvider.CODEC.fieldOf("stone_provider").forGetter(StoneClusterConfiguration::stoneProvider),
            FluidState.CODEC.fieldOf("fluid_provider").forGetter(StoneClusterConfiguration::fluidProvider),
            ...
            FloatProvider.codec(0, 2).fieldOf("density").forGetter(StoneClusterConfiguration::density),
            FloatProvider.codec(0, 2).fieldOf("wetness").forGetter(StoneClusterConfiguration::wetness),
            FloatProvider.codec(0, 2).fieldOf("lavaness").forGetter(StoneClusterConfiguration::lavaness),
            FloatProvider.codec(0, 2).fieldOf("thirdthingness").forGetter(StoneClusterConfiguration::thirdthingness),
            Codec.floatRange(0, 1).fieldOf("chance_of_dripstone_column_at_max_distance_from_center").forGetter(StoneClusterConfiguration::chanceOfDripstoneColumnAtMaxDistanceFromCenter),
