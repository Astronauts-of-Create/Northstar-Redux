...
public class NorthstarMechanicalCraftingGen extends MechanicalCraftingRecipeGen {
    ...
    ROCKET_WAYPOINT = create(NorthstarBlocks.ROCKET_WAYPOINT::get)
            .returns(1)
            .recipe(b -> b.key('B', NorthstarItemTags.C_INGOTS_TUNGSTEN.tag)
                    .key('C', NorthstarItems.TARGETING_COMPUTER)
                    .key('D', NorthstarItems.POLISHED_DIAMOND)
                    .key('H', NorthstarItems.HARDENED_PRECISION_MECHANISM)
