...
public class NorthstarSounds {
    ...
    public static final RegistryObject<SoundEvent> ROCKET_BLAST = registerRangedSound("rocket_blast", 256f);
    public static final RegistryObject<SoundEvent> ROCKET_LANDING = registerRangedSound("rocket_landing", 256f);
