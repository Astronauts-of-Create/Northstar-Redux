...
public class NorthstarDimensions {
    ...
    public static void bootstrapDimensions(BootstapContext<PlanetDimension> context) {
        context.register(
    ...
    private static void registerOrbit(BootstapContext<LevelStem> context, ResourceKey<Level> key) {
