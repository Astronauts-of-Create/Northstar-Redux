...
public class NorthstarPlacedFeatures {
    ...
    public static void register(BootstapContext<PlacedFeature> context, ResourceKey<PlacedFeature> key, ResourceKey<ConfiguredFeature<?, ?>> feature, PlacementModifier... placements) {
        context.register(
                key,
                new PlacedFeature(
