    ...
    default void northstar$blitRepeating(TextureAtlasSprite sprite, int x, int y, int w, int h, TilingAnchor anchor) {
        ...
        for (int tileX = 0; tileX <= tileCountX; tileX++) {
            ...
            for (int tileY = 0; tileY <= tileCountY; tileY++) {
                ...
                vertexBuffer.addVertex(m, drawX, nextY, 0).setUv(localU0, localV0);
                vertexBuffer.addVertex(m, nextX, nextY, 0).setUv(localU1, localV0);
                vertexBuffer.addVertex(m, nextX, drawY, 0).setUv(localU1, localV1);
                vertexBuffer.addVertex(m, drawX, drawY, 0).setUv(localU0, localV1);
            }
        }
