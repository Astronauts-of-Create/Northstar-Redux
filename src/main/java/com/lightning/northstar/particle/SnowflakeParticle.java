...
public class SnowflakeParticle extends SimpleAnimatedParticle {
    ...
    protected SnowflakeParticle(SimpleParticleType data, ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprite) {
