...
public class SnowflakeParticleData implements ParticleOptions, ICustomParticleDataWithSprite<SnowflakeParticleData> {
    ...
    public static final StreamCodec<ByteBuf, SnowflakeParticleData> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.VAR_INT, p -> p.posX,
            ByteBufCodecs.VAR_INT, p -> p.posY,
            ByteBufCodecs.VAR_INT, p -> p.posZ,
            SnowflakeParticleData::new
    );

    public static final MapCodec<SnowflakeParticleData> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
    ...
    @Override
    public MapCodec<SnowflakeParticleData> getCodec(ParticleType<SnowflakeParticleData> type) {
        return CODEC;
    }

    @Override
    public StreamCodec<? super RegistryFriendlyByteBuf, SnowflakeParticleData> getStreamCodec() {
        return STREAM_CODEC;
    }
