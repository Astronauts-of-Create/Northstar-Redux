...
public class RocketStationScreen extends AbstractSimiContainerScreen<RocketStationMenu> {
    ...
    protected void init() {
        ...
        holder.contraption().getStorage().createHandlers();
    ...
    private void saveSettings(boolean toggleAssembly) {
        NorthstarPackets.getChannel().sendToServer(new RocketStationEditPacket(
    ...
    private void updateInfo() {
        ...
        if (availableFuel == 0) {
            ...
            for (Object2IntMap.Entry<Fluid> entry : amounts.object2IntEntrySet()) {
                ...
                fuelTip = fuelTip
                        .append("\n")
                        .append(new FluidStack(entry.getKey(), 1).getDisplayName())
                        .append(" ")
